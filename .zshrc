...
plugins=(docker docker-compose docker-machine copydir copyfile colorize colored-man-pages branch aws fzf zsh-vim-mode systemd terraform tig tmux tmuxinator vagrant vagrant-prompt vault virtualenv virtualenvwrapper vscode vi-mode pyenv pylint python rsync sbt scala man minikube mosh nomad osx pip github history iterm2 kubectrl git-extras)
